...
<p align="center">
  <img src="https://github.com/kyletimmermans/tkinter-dijkstras-canvas/blob/master/media/newlook2.png?raw=true" alt="v3.0 Dark Mode Look"/>
</p>
...
### Installation
Download DijkstrasCanvas.zip which contains the .app file [here](https://github.com/kyletimmermans/tkinter-dijkstras-canvas/releases/download/v3.1/DijkstrasCanvas.zip)
  * Packaged with [Platypus](https://github.com/sveinbjornt/Platypus)

**or**

Run Tkinter Dijkstra's Canvas through command line:
...
3. Run `wget https://raw.githubusercontent.com/kyletimmermans/tkinter-dijkstras-canvas/master/DijkstrasCanvas.py`
...
Video of Tkinter Dijkstra's Canvas in action! [https://youtu.be/_1Sd_68PKYE](https://youtu.be/_1Sd_68PKYE)
...
|Available for MacOSX (.app): A GUI has been specifically crafted for MacOSX through testing and developing around the OS's rendering system, making Tkinter Dijkstra's Canvas look like a native app!|

</br>

### Example
Geeksforgeeks.org has a well-made undirected weighted graph image that I will use as an example and re-create it in Tkinter Dijsktra's Canvas. 
If we are given a graph such as this one:

<p align="center">
  <img src="https://github.com/kyletimmermans/tkinter-dijkstras-canvas/blob/master/media/UndirectedWeightedGraph.png?raw=true" alt="Sample Graph"/>
</p>

We can draw the same graph in the program and give it the same edge weights.

<p align="center">
  <img src="https://github.com/kyletimmermans/tkinter-dijkstras-canvas/blob/master/media/GraphTranslation2.png?raw=true" alt="Graph Translation"/>
</p>
...
<p align="center">
  <img src="https://github.com/kyletimmermans/tkinter-dijkstras-canvas/blob/master/media/adjacencyMatrix.png?raw=true" alt="Adjacency Matrix"/>
</p>
...
![alt text](https://github.com/kyletimmermans/tkinter-dijkstras-canvas/blob/master/media/pseudocode.png "Pseudocode")
...
<p align="center">
  <img src="https://github.com/kyletimmermans/tkinter-dijkstras-canvas/blob/master/media/fun1.png?raw=true" alt="Dijkstra's Canvas"/>
</p>

<div>&ensp;</div>

<p align="center">
  <img src="https://github.com/kyletimmermans/tkinter-dijkstras-canvas/blob/master/media/fun2.png?raw=true" alt="Dijkstra's Canvas"/>
</p>

<div>&ensp;</div>

<p align="center">
  <img src="https://github.com/kyletimmermans/tkinter-dijkstras-canvas/blob/master/media/fun3.png?raw=true" alt="Dijkstra's Canvas"/>
</p>
